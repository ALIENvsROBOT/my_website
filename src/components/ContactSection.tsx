            ...
            >
              ...
              <div className="grid grid-cols-2 gap-4">
                <a 
                  ...
                  className="flex items-center gap-3 p-3 bg-[#0077b5]/20 rounded-lg hover:bg-[#0077b5]/30 transition-colors"
                >
                  <div className="p-2 bg-[#0077b5]/30 rounded-full">
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="flex items-center gap-3 p-3 bg-[#333]/20 rounded-lg hover:bg-[#333]/30 transition-colors"
                >
                  <div className="p-2 bg-[#333]/30 rounded-full">
                    <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
